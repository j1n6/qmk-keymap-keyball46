...
__attribute__((weak)) void oledkit_render_logo_user(void) { return oled_write_P(logo, false); }

__attribute__((weak)) void oledkit_render_info_user(void) { return oled_write_P(logo, false); }
